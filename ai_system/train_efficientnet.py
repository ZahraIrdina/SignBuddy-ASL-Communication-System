...
# EfficientNet already includes preprocessing internally
...
plt.ylabel("Accuracy")
plt.legend()
plt.savefig(os.path.join(GRAPH_DIR, "efficientnet_accuracy.png"))
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig(os.path.join(GRAPH_DIR, "efficientnet_loss.png"))
plt.close()
